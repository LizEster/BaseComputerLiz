...
# Tamaños nuevos (bytes de DATA, sin header ni CRC)
TYPES_PAYLOAD = {
    IMAGE_TYPE: 48,
    IMU_TYPE:   18,  # antes 36 → 9 × int16
    GPS_TYPE:   10,  # antes 16 → int32 + int32 + int16
    BARO_TYPE:   6,  # antes 12 → uint16 + int16 + uint16
}

# Factores de escala para reconstruir las unidades reales
...
class Transfer:
    ...
    def receive_packets(self):
        while True:
            ...
            timestamp = self.getbytes(3)  # cambiado de 4 a 3
